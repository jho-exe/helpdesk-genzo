...
class Email extends PHPMailer{
    ...
    protected $gCorreo = 'notificaciones@genzo.cl';
    protected $gContrasena = 'Desarrollo01.';
    ...
    public function ticket_abierto($tick_id){
        ...
        //TODO: IGual//
        $this->IsSMTP();
        $this->Host = 'mail.genzo.cl';//Aqui el server
        ...
        $this->addAddress("javier.hormazabal@genzo.cl");
