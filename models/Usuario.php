<?php
    class Usuario extends Conectar{
        ...
        public function insert_usuario($usu_nom,$usu_ape,$usu_correo,$usu_pass,$rol_id,$usu_telf,$usu_emp,$usu_obs){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_usuario (usu_id, usu_nom, usu_ape, usu_correo, usu_pass, rol_id, usu_telf, usu_emp, usu_obs, fech_crea, fech_modi, fech_elim, est) VALUES (NULL,?,?,?,MD5(?),?,?,?,?,now(), NULL, NULL, '1');";
            ...
            $sql->bindValue(7, $usu_emp);
            $sql->bindValue(8, $usu_obs);
            $sql->execute();
            return $resultado=$sql->fetchAll();
        }

        public function update_usuario($usu_id,$usu_nom,$usu_ape,$usu_correo,$usu_pass,$rol_id,$usu_telf,$usu_emp,$usu_obs){
            $conectar= parent::conexion();
            parent::set_names();
