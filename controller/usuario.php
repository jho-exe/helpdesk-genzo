    ...
    switch($_GET["op"]){
        case "guardaryeditar":
            if(empty($_POST["usu_id"])){       
                $usuario->insert_usuario($_POST["usu_nom"],$_POST["usu_ape"],$_POST["usu_correo"],$_POST["usu_pass"],$_POST["rol_id"],$_POST["usu_telf"],$_POST["usu_emp"],$_POST["usu_obs"]);     
            }
            else {
                $usuario->update_usuario($_POST["usu_id"],$_POST["usu_nom"],$_POST["usu_ape"],$_POST["usu_correo"],$_POST["usu_pass"],$_POST["rol_id"],$_POST["usu_telf"],$_POST["usu_emp"],$_POST["usu_obs"]);
            }
            break;
        ...
        case "listar":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = $row["usu_emp"];
                $sub_array[] = $row["usu_obs"];
                if ($row["rol_id"]=="1"){
