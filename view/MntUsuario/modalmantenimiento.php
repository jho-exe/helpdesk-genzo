            ...
            <form method="post" id="usuario_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="usu_emp" name="usu_emp" placeholder="Ingrese Empresa" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="usu_obs">Observacion</label>
                        <input type="text" class="form-control" id="usu_obs" name="usu_obs" placeholder="Ingrese Observacion" required>
                    </div>
