...
<html>
	...
	<title>GENZO/HELPDESK - Perfil</title>
</head>
        	...
        	<form method="post" id="usuario_form">
				<div class="box-typical box-typical-padding">
					...
					<input type="hidden" id="usu_id" name="usu_id">
						...
						<div class="col-lg-4">
							<fieldset class="form-group">
								<label class="form-label semibold" for="usu_telf">Telefono</label>
								<input type="text" class="form-control" id="usu_telf" name="usu_telf" readonly>
							</fieldset>
						</div>
						<div class="col-lg-6">
							<fieldset class="form-group">
